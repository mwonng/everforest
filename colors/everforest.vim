...
call everforest#highlight('MiniStatuslineModeInsert', s:palette.bg0, s:palette.statusline3, 'bold')
...
call everforest#highlight('MiniStatuslineModeVisual', s:palette.bg0, s:palette.statusline2, 'bold')
